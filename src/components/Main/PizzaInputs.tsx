...
const PizzaInputs: FC<IPizzaInputsProps> = ({
    ...
    return (
        <>
            <div className="pizza-item__inputs-weight">
                <div className="pizza-item__inputs">
                    <input
                ...
                <div className="pizza-item__weight">
                    <svg
                        className="pizza-item__weight-svg"
                    ...
                    <span className="pizza-item__weight-span">{`Вага: ${
